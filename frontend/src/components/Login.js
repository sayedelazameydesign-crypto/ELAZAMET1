...
function Login({ onLogin }) {
  ...
  const handleForgotPassword = () => {
    ...
    const resetUrl = `${process.env.REACT_APP_AUTH0_DOMAIN}/u/reset-password?email=${sanitizedEmail}`;
    ...
    <div className="login-container">
      <div className="login-card">
        ...
        <div className="logo-container">
          <h1 className="logo">CELIA FASHION DESIGN</h1>
        </div>
        ...
        <div className="welcome-section">
          ...
          <p className="welcome-subtitle">
            {isSignup ? 'Create your account to get started with Celia Fashion Design.' : 'Log in to continue to Celia Fashion Design.'}
          </p>
        </div>
        ...
        <div className="login-footer">
          <p>
            By continuing, you agree to Celia Fashion Design's{' '}
